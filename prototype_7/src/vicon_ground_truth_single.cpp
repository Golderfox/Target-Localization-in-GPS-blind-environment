...
int main(int argc, char **argv){
  ...
  // Synchroniser policy
  typedef message_filters::sync_policies::ApproximateTime<geometry_msgs::TransformStamped, geometry_msgs::TransformStamped> SyncPolicy;
  message_filters::Synchronizer<SyncPolicy> sync(SyncPolicy(10), sub_vicon2, sub_vicon_target);
  sync.registerCallback(boost::bind(&viconCallbackBis, _1, _2));
