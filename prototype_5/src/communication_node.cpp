...
#include <prototype_5/DKF.h>
#include <prototype_5/DKFStamped.h>
#include <prototype_5/DKF_multi.h>
...
prototype_5::DKF drone_out_1;
prototype_5::DKF drone_out_2;
prototype_5::DKF drone_out_3;
prototype_5::DKF drone_out_4;
prototype_5::DKF drone_out_5;
prototype_5::DKF drone_out_6;
...
geometry_msgs::Pose DKFToPose(prototype_5::DKF msg){
...
void droneCallback(const prototype_5::DKFStamped::ConstPtr drone_msg_1, const prototype_5::DKFStamped::ConstPtr drone_msg_2, const prototype_5::DKFStamped::ConstPtr drone_msg_3, const prototype_5::DKFStamped::ConstPtr drone_msg_4, const prototype_5::DKFStamped::ConstPtr drone_msg_5, const prototype_5::DKFStamped::ConstPtr drone_msg_6){
  ROS_INFO("Odometry");
...
int main(int argc, char **argv){
  ...
  // DKF subscribers
  message_filters::Subscriber<prototype_5::DKFStamped> sub_com1(n, "/quadrotor1/output_com", 1);
  message_filters::Subscriber<prototype_5::DKFStamped> sub_com2(n, "/quadrotor2/output_com", 1);
  message_filters::Subscriber<prototype_5::DKFStamped> sub_com3(n, "/quadrotor3/output_com", 1);
  message_filters::Subscriber<prototype_5::DKFStamped> sub_com4(n, "/quadrotor4/output_com", 1);
  message_filters::Subscriber<prototype_5::DKFStamped> sub_com5(n, "/quadrotor5/output_com", 1);
  message_filters::Subscriber<prototype_5::DKFStamped> sub_com6(n, "/quadrotor6/output_com", 1);

  // Synchroniser policy
  typedef message_filters::sync_policies::ApproximateTime<prototype_5::DKFStamped, prototype_5::DKFStamped, prototype_5::DKFStamped, prototype_5::DKFStamped, prototype_5::DKFStamped, prototype_5::DKFStamped> SyncPolicy;
  ...
  */
  ...
  ros::Publisher pub_output1 = n.advertise<prototype_5::DKF_multi>("/quadrotor1/input_com",1000);
  ros::Publisher pub_output2 = n.advertise<prototype_5::DKF_multi>("/quadrotor2/input_com",1000);
  ros::Publisher pub_output3 = n.advertise<prototype_5::DKF_multi>("/quadrotor3/input_com",1000);
  ros::Publisher pub_output4 = n.advertise<prototype_5::DKF_multi>("/quadrotor4/input_com",1000);
  ros::Publisher pub_output5 = n.advertise<prototype_5::DKF_multi>("/quadrotor5/input_com",1000);
  ros::Publisher pub_output6 = n.advertise<prototype_5::DKF_multi>("/quadrotor6/input_com",1000);

  //----------------------------
  // Init messages
  prototype_5::DKF_multi drone_input_1;
  prototype_5::DKF_multi drone_input_2;
  prototype_5::DKF_multi drone_input_3;
  prototype_5::DKF_multi drone_input_4;
  prototype_5::DKF_multi drone_input_5;
  prototype_5::DKF_multi drone_input_6;

  std::vector<prototype_5::DKF> DKF_array_1;
  std::vector<prototype_5::DKF> DKF_array_2;
  std::vector<prototype_5::DKF> DKF_array_3;
  std::vector<prototype_5::DKF> DKF_array_4;
  std::vector<prototype_5::DKF> DKF_array_5;
  std::vector<prototype_5::DKF> DKF_array_6;
  ...
  while (ros::ok()){
    ...
    if (flag_callback == TRUE){
      ...
      // Check link 1-2
      if(drone_out_1.y_size !=0 && drone_out_2.y_size !=0){
        if(getDistance(sensor_pose_1, sensor_pose_2) < TARGET_RADIUS){
      ...
      // Check link 1-3
      if(drone_out_1.y_size !=0 && drone_out_3.y_size !=0){
        if(getDistance(sensor_pose_1, sensor_pose_3) < TARGET_RADIUS){
      ...
      // Check link 1-4
      if(getDistance(sensor_pose_1, sensor_pose_4) < TARGET_RADIUS){
        if(drone_out_4.y_size !=0){
      ...
      // Check link 1-5
      if(getDistance(sensor_pose_1, sensor_pose_5) < TARGET_RADIUS){
        if(drone_out_5.y_size !=0){
      ...
      // Check link 1-6
      if(getDistance(sensor_pose_1, sensor_pose_6) < TARGET_RADIUS){
        if(drone_out_6.y_size !=0){
      ...
      // Check link 2-3
      if(getDistance(sensor_pose_2, sensor_pose_3) < TARGET_RADIUS){
        if(drone_out_3.y_size !=0){
      ...
      // Check link 2-4
      if(getDistance(sensor_pose_2, sensor_pose_4) < TARGET_RADIUS){
        if(drone_out_4.y_size !=0){
      ...
      // Check link 2-5
      if(getDistance(sensor_pose_2, sensor_pose_5) < TARGET_RADIUS){
        if(drone_out_5.y_size !=0){
      ...
      // Check link 2-6
      if(getDistance(sensor_pose_2, sensor_pose_6) < TARGET_RADIUS){
        if(drone_out_6.y_size !=0){
      ...
      // Check link 3-4
      if(getDistance(sensor_pose_3, sensor_pose_4) < TARGET_RADIUS){
        if(drone_out_4.y_size !=0){
      ...
      // Check link 3-5
      if(getDistance(sensor_pose_3, sensor_pose_5) < TARGET_RADIUS){
        if(drone_out_5.y_size !=0){
      ...
      // Check link 3-6
      if(getDistance(sensor_pose_3, sensor_pose_6) < TARGET_RADIUS){
        if(drone_out_6.y_size !=0){
      ...
      // Check link 4-5
      if(getDistance(sensor_pose_4, sensor_pose_5) < TARGET_RADIUS){
        if(drone_out_5.y_size !=0){
      ...
      // Check link 4-6
      if(getDistance(sensor_pose_4, sensor_pose_6) < TARGET_RADIUS){
        if(drone_out_6.y_size !=0){
      ...
      // Check link 5-6
      if(getDistance(sensor_pose_5, sensor_pose_6) < TARGET_RADIUS){
        if(drone_out_6.y_size !=0){
