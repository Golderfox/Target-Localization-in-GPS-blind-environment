...
void commCallback(const prototype_7::DKF_multi& msg)
{
  ROS_INFO("Comm Back");
...
void Callback(const prototype_7::DKF::ConstPtr drone_1, const prototype_7::DKF::ConstPtr drone_2, const prototype_7::DKF::ConstPtr drone_3)
{
...
int main(int argc, char **argv){
  ...
  */
  ...
  ros::Publisher pub_com_output = n.advertise<prototype_7::DKFStamped>("output_com",1000);
  ...
  //----------------------------
  // Set msgs
  prototype_7::DKFStamped com_out_msg;
  prototype_7::DKF DKF_out_msg;
