...
void droneCallback(const geometry_msgs::PoseStamped::ConstPtr drone_msg_1, const geometry_msgs::PoseStamped::ConstPtr drone_msg_2){
  ROS_INFO("Odometry");
...
int main(int argc, char **argv){
  ...
  message_filters::Synchronizer<SyncPolicy> sync(SyncPolicy(10), sub_odom1, sub_odom2);
