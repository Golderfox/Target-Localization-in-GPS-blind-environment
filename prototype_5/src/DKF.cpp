...
std::vector<prototype_5::DKF> communication_data;
...
void commCallback(const prototype_5::DKF_multi& msg)
{
  ROS_INFO("Comm Back");
...
void Callback(const prototype_5::DKF::ConstPtr drone_1, const prototype_5::DKF::ConstPtr drone_2, const prototype_5::DKF::ConstPtr drone_3)
{
...
int main(int argc, char **argv){
  ...
  */
  ...
  ros::Publisher pub_com_output = n.advertise<prototype_5::DKFStamped>("output_com",1000);
  ...
  ros::Publisher pub_test = n.advertise<prototype_5::DKF_multi>("test",1000);
  ...
  //----------------------------
  // Set msgs
  prototype_5::DKFStamped com_out_msg;
  prototype_5::DKF DKF_out_msg;
        ...
        */
        ...
        for(int i=0; i<neighbours.size(); i++){
          ...
          if(odom_ptr.twist.twist.linear.x > 0.04){
            ...
            vector_control += 10.0*(p - q)/std::pow(interspace_distance, 3.0);
          }
