...
void droneCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr drone_msg_1, const geometry_msgs::PoseWithCovarianceStamped::ConstPtr drone_msg_2){
  ROS_INFO("Odometry");
...
int main(int argc, char **argv){
  ...
  message_filters::Subscriber<geometry_msgs::PoseWithCovarianceStamped> sub_est2(n, "/quadrotor0/estimate", 1);

  // Synchroniser policy
  typedef message_filters::sync_policies::ApproximateTime<geometry_msgs::PoseWithCovarianceStamped, geometry_msgs::PoseWithCovarianceStamped, geometry_msgs::PoseWithCovarianceStamped, geometry_msgs::PoseWithCovarianceStamped, geometry_msgs::PoseWithCovarianceStamped, geometry_msgs::PoseWithCovarianceStamped> SyncPolicy;
  message_filters::Synchronizer<SyncPolicy> sync(SyncPolicy(10), sub_est1, sub_est2);
